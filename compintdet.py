...
plt.plot(dataint[0], dataint[1], 'r', label = 'internal noise')
plt.plot(datadet[0], datadet[1], 'g', label = 'external noise')
plt.subplot(212)
plt.title("Kolmogorov-Smirnov distance")
plt.plot(dataint[0], dataint[2], 'r', label = 'internal noise')
plt.plot(datadet[0], datadet[2], 'g', label = 'external noise')
plt.show()
